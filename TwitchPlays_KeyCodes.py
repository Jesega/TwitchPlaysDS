...
# Holds and release the second key for seconds while the first one is held
def HoldAndReleaseBothKeys(firstKey, secondKey, seconds):
    HoldKey(firstKey)
    HoldAndReleaseKey(secondKey, seconds)
    ReleaseKey(firstKey)